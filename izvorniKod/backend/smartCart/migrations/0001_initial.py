# Generated by Django 3.1.2 on 2020-12-07 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_level', models.CharField(choices=[('G', 'Gost'), ('K', 'Kupac'), ('T', 'Trgovac'), ('A', 'Administrator')], default='Gost', max_length=7)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('naziv_artikla', models.CharField(max_length=100)),
                ('opis_artikla', models.CharField(max_length=5000, null=True)),
                ('broj_glasova', models.IntegerField(default=0)),
                ('masa', models.IntegerField(null=True)),
                ('prioritiziran', models.BooleanField(default=False)),
                ('artikl', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='smartCart.artikl')),
                ('autor_opisa', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('trgovina', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='smartCart.trgovina')),
                ('trgovina_artikl', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='smartCart.trgovinaartikli')),
                ('vrsta', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='smartCart.vrsta')),
                ('zemlja_porijekla', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='smartCart.zemlja_porijekla')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name='vrsta',
            constraint=models.UniqueConstraint(fields=('potkategorija', 'sif_vrsta'), name='constraint_2'),
        ),
        migrations.AddConstraint(
            model_name='potkategorija',
            constraint=models.UniqueConstraint(fields=('kategorija', 'sif_potkategorija'), name='constraint_1'),
        ),
        migrations.AddConstraint(
            model_name='opisartikla',
            constraint=models.UniqueConstraint(fields=('autor_opisa', 'artikl'), name='constraint_3'),
        ),
    ]
