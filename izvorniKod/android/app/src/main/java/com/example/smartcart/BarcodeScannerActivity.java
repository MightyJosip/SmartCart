...
public class BarcodeScannerActivity extends AppCompatActivity {
    ...
    private void startScanning() {
        ...
        View manualInputView = findViewById(R.id.manual_input_div);
    ...
    public void onSubmitBarcode(View v) {
        returnResult(((EditText) findViewById(R.id.barcode_edittext)).getText().toString());
    }
}